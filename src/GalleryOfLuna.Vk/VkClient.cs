using GalleryOfLuna.Vk.Json;
using GalleryOfLuna.Vk.Responses;
using GalleryOfLuna.Vk.Responses.Docs;
...
namespace GalleryOfLuna.Vk
{
    public sealed class VkClient
    {
        ...
        public VkClient(HttpClient httpClient, VkConfiguration configuration)
        {
        ...
        public async Task<UploadDocumentResponse> UploadDocumnetAsync(
            string uploadUrl,
            string imageFormat,
            byte[] fileStream,
            CancellationToken cancellationToken = default)
        {
            ...
            return await SendRequestAsync<UploadDocumentResponse>(uploadUrl, HttpMethod.Post, content, cancellationToken);
        }
